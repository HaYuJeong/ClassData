...
-- 1) 담당 업무별 평균 급여를 구한 후 그 중 가장 작은 급여 : 1038
SELECT MIN(ROUND(AVG(SALARY)))
FROM EMPLOYEE
GROUP BY JOB;

-- 2) 그 급여에 해당되는 직급(JOB), 평균급여(AVG(SALARY))를 출력
...
SELECT ENAME
FROM EMPLOYEE
WHERE ENO IN (7369,7499,7521,7566,7654,7698,7782,7788,7844,7876,7900,7902,7934);
